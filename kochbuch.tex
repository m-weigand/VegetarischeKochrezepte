...
\begin{center}
    {Zusammengestellt von Maximilian Weigand (mweigand@mweigand.net), Februar 2016, Ausgabe 4}
\end{center}
\vfill
\begin{center}
...
\include{Ingwer-Zwiebel-Gericht/rezept}
...
\include{Pfannkuchen/rezept}
\include{RoteLinsenSuppe/rezept}
\include{Salatsausse/rezept}
\include{Schupfnudeln-Satee/rezept}
\include{Sherry-Risotto/rezept}
\include{Schokocreme/rezept}
